...
export function QuotationStatusActions({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {(status === "APPROVED" || status === "SENT") && canConvert && (
        <Dialog open={convertOpen} onOpenChange={setConvertOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Creates a DRAFT JO with this quotation&apos;s items and locks
                the quote as Converted. The JO still needs customer-approval
                proof before production starts.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button
